...
```{r echo=FALSE, fig.align="center", fig.width=6, fig.height=6, fig.cap= "Figure 3: QQ plot"}
ggplot(Age_result, aes(sample=P))+
  stat_qq()+
  theme_classic()
```
...
```{r fig.align="center", fig.width=5, fig.height=5, fig.cap= "Figure 4: Circular Manhattan plot"}
