...
```{r, echo=FALSE, fig.align="center", fig.width=6, fig.height=6, fig.cap= "Figure 1: Age-specific incidence rate in childhood ALL"}
...
```{r echo=FALSE, fig.align="center", out.width= "75%", fig.cap= "Figure 3: QQ plot"}
qq(Age_result$P)
```
...
```{r fig.align="center", out.width= "80%", fig.cap= "Figure 4: Circular Manhattan plot"}
